...
- [Getting Started](#getting-started)
  ...
  - [JavaScript](#javascript)
    ...
    - [`pauseAR` - Pause AR](#startvuforiatrackers---start-vuforia-image-trackers)
    - [`resumeAR` - Resume AR](#updatevuforiatargets---update-the-list-of-targets-vuforia-is-searching-for)
